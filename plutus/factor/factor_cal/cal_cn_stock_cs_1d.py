...
from plutus.factor.factor_define.cn_stock_cs_1d_mom import Mom
...
class CalMom(CalFactor):
    ...
    def cal_and_save_all_factor(
        ...
        for factor_name in factor_name_list:
            ...
            self.save_parquet(
                factor_df, data_dir=self.factorhub_dir, db=db, tb=f"{tb}{factor_name}/"
            )
