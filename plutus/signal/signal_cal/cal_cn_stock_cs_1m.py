from plutus.signal.signal_cal.cal_signal_base import CalSignal
...
class CalSignalMom(CalSignal):
    def __init__(self, signalhub_dir: str = "/mnt/gitee/quanthub/signalhub/"):
        ...
        self.stock_list = []
        self.sginal_db = "raw/cn/stock/cs/1m/"
        self.sginal_tb = "mom/"
...
if __name__ == "__main__":
    ...
    all_factor_df = cal_signal_mom.read_parquet(
        "/mnt/gitee/quanthub/factorhub/raw/cn/stock/cs/1m/mom/",
        filters=[("code", "in", cal_signal_mom.stock_list)],
    )
